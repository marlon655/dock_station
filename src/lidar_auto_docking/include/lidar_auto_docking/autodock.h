...
class DockingServer : public rclcpp::Node {
 public:
  ...
  explicit DockingServer(
    ...
    this->declare_parameter<double>("docking_timeout_sec", 120.0);
    this->get_parameter("docking_timeout_sec", docking_timeout_sec_);
 ...
 private:
  ...
  double docking_timeout_sec_;  // Maximum docking duration in seconds.
